...
{
    /// <summary>
    /// The WangTiffToPdfWangAnnotationHandler class implements the IWangAnnotationHandler interface for debug purpose.
    /// </summary>
    /// <remarks>
    /// This class converts the annotation information received through the interface into GdPicture.NET annotations for a PDF.
    ...
    /// </remarks>
    class WangTiffToPdfWangAnnotationHandler : IWangAnnotationHandler
    {
        /// <summary>
        ...
        private Color GdPictureColor(byte[] colorComponents)
        {
